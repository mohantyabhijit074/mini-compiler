...
{
       0,    43,    43,    46,    49,    51,    52,    53,    54,    55,
      56,    57,    58,    62,    62,    66,    67,    68,    71,    74,
      77,    80,    83,    84,    85,    88,    89,    90,    94,    97,
     100,   101,   104,   105,   106,   107,   108,   109,   112,   113,
     116,   117,   120,   122,   126,   127,   130,   133,   136,   137,
...
{
     -13,   -20,    47,    18,   -69,    21,    50,   -69,   -69,     2,
      38,    46,    92,    13,   101,   -69,   -69,    56,   -69,   -10,
      57,    98,    13,     2,    54,   -69,     2,     2,     2,     2,
      99,     2,    23,    32,   -69,   -69,   -69,   -69,   -69,    -4,
      73,    62,   100,    13,   -69,   -69,   -69,   -69,   -69,   -69,
      68,   -69,   -69,   -69,   -69,    26,   -69,   -69,   -69,   -69,
     -69,   -69,    29,    78,   -69,   -69,     2,    13,    13,    13,
      13,   102,   -69,   107,    15,    13,   -69,   -69,   -69,    13,
     -69,   103,   -69,    32,    32,   -69,   -69,    29,    13,   120,
     -69,   105,    64,    28,   -69,   125,   -69,   -69,    39,   -69,
      93,   -69,   -69,   -69,   102,    35,   -69,   -69,   -69,   -69,
     -69,   -69,   -69,   -69,    13,    13,    84,   -69,    43,   115,
      75,    75,   109,   126,    58,    50,    87,   -69,    88,   -69,
     -69,   -69,     2,     2,   -69,   -69
};
...
static const yytype_int8 yydefact[] =
{
      ...
      10,    11,    43,     0,    39,     6,    12,     0,     0,     0,
       0,     0,    56,     0,     0,     0,    59,    60,    24,     0,
      38,     0,     5,    48,    49,    51,    52,     0,     0,     0,
      45,     0,     0,     0,    42,     0,    25,    26,    27,    13,
       0,    44,    61,    47,     0,     0,    30,    31,    36,    37,
      32,    33,    34,    35,     0,     0,     0,    46,     0,     0,
      29,    28,     0,     0,    15,     0,     0,    14,     0,    17,
      16,    21,    12,    12,    18,    19
};
...
{
     -69,   -69,    -6,   -69,   -22,   -69,   -69,    14,   -69,   -69,
     -69,   -69,   -69,   -69,   -69,   -69,   -69,   -69,   -69,   104,
     -69,    48,   -68,   -11,    40,    51,   -69,   -69,    36
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int16 yydefgoto[] =
{
      -1,     2,    23,     9,    24,    25,   116,   123,   124,   130,
      26,    27,    28,    95,    96,    97,   114,   115,    29,    30,
...
{
       8,    56,    41,    88,    58,    59,    60,    61,     1,    65,
       7,    55,    10,    11,    51,    52,    12,    15,    16,    13,
      90,    91,    14,    15,    16,     3,    17,    18,    66,    19,
      13,    78,    74,   103,   104,     5,   117,    40,    18,     6,
      19,    67,    68,    37,    82,    20,    21,     4,    22,    67,
      68,    38,    67,    68,    67,    68,    20,    21,     7,   118,
      69,    70,    19,    57,    92,    67,    68,    79,    93,   106,
     107,   108,   109,   110,   111,   112,   113,    98,    20,    21,
      72,    53,   102,    80,    81,    75,    48,    49,    67,    68,
      67,    68,    76,    77,    43,    44,    45,    46,    47,    48,
      49,    67,    68,   120,   121,   128,   122,    83,    84,    39,
     134,   135,    44,    45,    46,    47,    48,    49,    42,   131,
      85,    86,    54,    62,    73,    89,    87,    94,    99,   100,
     105,    43,   122,   125,   126,   127,   132,   133,   129,   101,
       0,   119,     0,    71
};

static const yytype_int16 yycheck[] =
{
       6,    23,    13,    71,    26,    27,    28,    29,    21,    31,
       8,    22,    10,    11,    24,    25,    14,    21,    22,    17,
       5,     6,    20,    21,    22,    45,    24,    25,     5,    27,
      17,     5,    43,     5,     6,    17,   104,    24,    25,    18,
      27,    26,    27,     5,    66,    43,    44,     0,    46,    26,
      27,     5,    26,    27,    26,    27,    43,    44,     8,    24,
      28,    29,    27,     9,    75,    26,    27,    38,    79,    30,
      31,    32,    33,    34,    35,    36,    37,    88,    43,    44,
      18,    24,    18,     5,     6,    17,    43,    44,    26,    27,
      26,    27,    24,    25,    38,    39,    40,    41,    42,    43,
      44,    26,    27,   114,   115,    47,    48,    67,    68,    17,
     132,   133,    39,    40,    41,    42,    43,    44,    17,   125,
      69,    70,    24,    24,    24,    18,    24,    24,     8,    24,
       5,    38,    48,    18,    25,     9,    49,    49,   124,    91,
      -1,   105,    -1,    39
};
...
static const yytype_int8 yystos[] =
{
      ...
      29,    69,    18,    24,    73,    17,    24,    25,     5,    38,
       5,     6,    54,    74,    74,    75,    75,    24,    72,    18,
       5,     6,    73,    73,    24,    63,    64,    65,    73,     8,
      24,    71,    18,     5,     6,     5,    30,    31,    32,    33,
      34,    35,    36,    37,    66,    67,    56,    72,    24,    78,
      73,    73,    48,    57,    58,    18,    25,     9,    47,    57,
      59,    52,    49,    49,    54,    54
};
...
yyreduce:
  ...
  case 2:
#line 43 "parser.y"
                                             {(yyval.node) = make_leaf((yyvsp[-4].var_type)); (yyval.node)=make_node("Main",(yyvsp[-4].var_type),(yyvsp[0].node));fprintf(fp,"\t\tAbstract Syntax Tree:\n\n"); AST_print((yyval.node)); 																printf("\n\n");print_sym_tab(); YYACCEPT;}
#line 1637 "y.tab.c"
    break;
...
#line 1745 "y.tab.c"
  ...
  case 21:
#line 80 "parser.y"
                                                                                        {(yyval.node)=make_node("FOR",(yyvsp[-6].var_type),(yyvsp[-4].node));}
#line 1751 "y.tab.c"
    break;
...
#line 1853 "y.tab.c"
  ...
  case 39:
#line 113 "parser.y"
                         {(yyvsp[-1].var_type)=make_leaf((yyvsp[-1].var_type)); (yyval.node)=make_node("Assignment_expression",(yyvsp[-1].var_type),(yyvsp[0].node));}
#line 1859 "y.tab.c"
    break;
