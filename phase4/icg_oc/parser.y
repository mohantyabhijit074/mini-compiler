...
iter_stat : T_FOR T_OPEN Type assign_expr1 cond T_SC unary_expr T_CLOSE comp_stat  {char* begin = new_label(); 						 						
								 $5.true = new_label(); 
						                 $9.next = stack[top];
								 $5.false = $9.next;   
								 strcpy(break_lab,$9.next);
							         $$.code = code_concatenate(6,code_gen(4,"if ", $5.code, "goto ", $5.true), 
									   code_gen(2,"goto ", $5.false), code_gen(2,$5.true,": "),$9.code,code_gen(4,"if ", $5.code, "goto ", $5.true),code_gen(2,$9.next,": \n"));
								 if(num_iter)
								 {
								   $$.optimized_code = " ";
								   int i;
