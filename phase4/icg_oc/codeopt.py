f = open("Intermediate_quadruple.txt","r")
fout = open("out.txt","w")
...
for i in list_of_lines:
	i = i.strip("\n")
	op,arg1,arg2,res = map(str,i.split())
	if(op in ["+","-","*","/"]):
		if(arg1.isdigit() and arg2.isdigit()):
			...
			if(arg2 in dictValues):
				dictValues[arg2] = str(dictValues[arg2])
			...
			if(arg1 in dictValues):
				dictValues[arg1] = str(dictValues[arg1])
...
for i in constantFoldedList:
	if not ('t' in i[3] and len(i[3])<3 and i[0]=="="):
		if(i[0]=="="):
			print(i[3],i[0],i[1])
		elif(i[0] in ["+","-","*","/","==","<=","<",">",">="]):
